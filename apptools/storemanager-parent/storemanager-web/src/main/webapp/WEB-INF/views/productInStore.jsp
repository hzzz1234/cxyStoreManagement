...
<div class="main-container" id="main-container" >
      ...
      <div class="page-content">
        ...
        <div class="row" style="overflow: scroll">
          ...
          <div class="col-xs-12" style="margin-bottom: 10px">
            <button class=" btn btn-sm btn-success" onclick="WriteForm('${rc.contextPath}/productinstore/purchaseForm')">新增入库单据</button>
            ...
            &nbsp&nbsp<button class=" btn btn-sm btn-success">导入入库单据</button>
            &nbsp&nbsp<button class=" btn btn-sm btn-success">导出入库单据</button>
          </div>
          <div class="col-xs-12">
                ...
                <div>
                  <div id="sample-table-2_wrapper" class="dataTables_wrapper form-inline" role="grid">
                    ...
                    <span class="input-icon" style="right: 0px;float: right;" >
			           <input type="text" placeholder="入库单据号" class="nav-search-input" id="search-input" value="${keywords}">
                    ...
                    <tr role="row">
                      ...
                      <th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending">入库单据号</th>
                      ...
                      <th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending">供应商</th>
                      <th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending">入库数量</th>
                      ...
                      <th class="hidden-480" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending">单据说明</th>
                      <th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending">经办人</th>
                    ...
                    <c:forEach var="record" items="${records}">
                      ...
                      <tr  class="odd tableColoumHeadStyle" id="${record.id}">
                        ...
                        <td class="tableColoumContentStyle">${record.comment}</td>
  ...
  <script src="${rc.contextPath}/webresources/assets/js/ace.min.js"></script>
    ...
    <script src="${rc.contextPath}/webresources/storemanager/js/inStorePaging.js"></script>
    <script src="${rc.contextPath}/webresources/storemanager/js/productInStore.js"></script>
